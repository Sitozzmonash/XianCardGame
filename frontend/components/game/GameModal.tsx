...
export function GameModal({
  ...
  return (
    <div className="absolute inset-0 z-50 flex items-end justify-center sm:items-center" role="dialog" aria-modal="true">
      ...
      <div
        className={cn(
          'game-modal animate-rise relative z-10 w-full max-w-[400px] overflow-hidden rounded-t-3xl border p-5 sm:rounded-3xl',
          tone === 'blood'
            ? 'border-blood-500/50 bg-[linear-gradient(180deg,#321717_0%,#071614_60%)]'
            : 'border-gold-500/40 bg-[linear-gradient(180deg,#10352d_0%,#071614_60%)]',
