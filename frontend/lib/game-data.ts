...
export const API_CARD_TO_VISUAL: Record<string, CardId> = {
  TRIBULATION: 'tianjie',
  DEFUSE: 'hujiefu',
  STARGAZING: 'guanxingshu',
  REWRITE_FATE: 'nitiangaiming',
  SHUFFLE: 'raoluantianji',
  ESCAPE: 'dunshu',
  STEAL: 'shewushu',
  COUNTER: 'fanzhifu',
}

export function visualCard(cardId: string | null | undefined): GameCardData {
  return CARD_BY_ID[API_CARD_TO_VISUAL[cardId ?? ''] ?? 'guanxingshu']
}
